...
const supabase = createClient(
  process.env.https://jjepqeltkmudjawsmpm.supabase.co
  process.env.eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpqZXBxZWx0a211ZGphd3NtcG1sIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTUwNjE3NywiZXhwIjoyMDkxMDgyMTc3fQ.0jdttl2EAhFofHPViCYx7UFSXgR_ie59LzbhPXHx1LU
)
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (tenantError || !tenant) return NextResponse.json({ error: 'Firma oluşturulamadı.' }, { status: 500 })
